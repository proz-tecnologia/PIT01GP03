...
class AccountRecoveryController extends ChangeNotifier {
  ...
  Future<void> forgotPassword(String email) async {
    try {
      ...
      infoMessage = 'O Reset da senha foi enviado para o seu e-mail. Clique em Login para entrar com a nova senha.';
      _updateState(AccountRecoverySuccessState());
    } catch (e) {
      _updateState(AccountRecoveryErrorState("Erro, tente novamente"));
    }
  }
}
